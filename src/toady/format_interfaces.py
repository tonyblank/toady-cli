...
class IFormatter(ABC):
    ...
    def format_success_message(self, message: str, details: Optional[Dict[str, Any]] = None) -> str:
        ...
        """
        if details:
            return self.format_object({"success": True, "message": message, "details": details})
    ...
    def format_warning_message(self, message: str, details: Optional[Dict[str, Any]] = None) -> str:
        ...
        """
        if details:
            return self.format_object({"warning": True, "message": message, "details": details})
...
class BaseFormatter(IFormatter):
    ...
    def _handle_empty_data(self, data: Any, empty_message: str = "No data available.") -> Optional[str]:
...
class FormatterFactory:
    ...
    def create(cls, name: str, **options: Any) -> IFormatter:
        ...
        try:
            ...
            raise FormatterError(
                f"Failed to create formatter '{name}': {str(e)}", 
                original_error=e
            ) from e
