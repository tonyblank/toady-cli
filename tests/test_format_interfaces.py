...
class TestBaseFormatter:
    ...
    def test_safe_serialize_with_non_serializable_object(self):
        ...
        class NonSerializable:
            def __init__(self):
                self.data = {1, 2, 3}  # sets are not JSON serializable
    ...
    def test_handle_empty_data(self):
        ...
        assert (
            formatter._handle_empty_data([], "Custom empty message")
...
class TestFormatterOptions:
    ...
    def test_to_dict(self):
        ...
        options = FormatterOptions(
            indent=4, sort_keys=True, custom_option="value", another_option=42
        )
...
class TestFormatterIntegration:
    ...
    def test_formatter_chaining(self):
        ...
        format_object_calls = [
            call for call in formatter.format_calls if call == "format_object"
        ]
