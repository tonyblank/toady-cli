            ...
            try:
                ...
                for line in content.split('\n'):
                    ...
                    if line.startswith('@pytest.mark.'):
                        ...
                        analysis["test_markers"][marker] = analysis["test_markers"].get(marker, 0) + 1
        ...
        for name, cmd in checks:
            if cmd:
                ...
                if name == "source code":
                    ...
                    if self.test_dir.exists() and list(self.test_dir.rglob("test_*.py")):
                        print(f"   ✅ {name}: OK")
                    else:
...
def main():
    ...
    parser.add_argument(
        "action",
        choices=["setup", "fast", "full", "integration", "performance", 
                "analyze", "report", "validate"],
